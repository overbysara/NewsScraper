...
A web app that lets users view and leave comments on the latest news articles scraped via Mongoose and Cheerio.

NPM Packages used: express, express-handlebars, mongoose, cheerio, and axios.

Deployed to Heroku: https://calm-sands-80893.herokuapp.com/ 


7. When you go to connect your mongo database to mongoose, do so the following way:
Created mongolab-trapezoidal-65137 as MONGGODB_URI
